        ...
        if address == serverAddress then
            ...
            if port == 253 then
                ...
                if message == 'R' or message == 'C' then
                    ...
                    if message == myMessage then gpu.setForeground(0x40FF40) else computer.beep(500, 0.1) end
                    if string.sub(message, 1, 8) == "[Server]" then gpu.setForeground(0xFF4040) end
                    while true do
